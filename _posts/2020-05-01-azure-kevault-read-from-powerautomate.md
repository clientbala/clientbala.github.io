...
<img src="../images/posts/3/Azure-KV-Invalid-Connection.png" width="80%" height="80%">
...
<img src="../images/posts/3/PowerAutomate - KV - Connection - NotAuthenticated.png"  width="80%" height="80%">

#### Fix the Connection
The above can be fixed, by editing the connection and updating it with the actual KeyVault name to be connected.

<img src="../images/posts/3/PowerAutomate - KV - Connection - KVName.png"  width="80%" height="80%">
...
<img src="../images/posts/3/PowerAutomate - KV - Connection - Connected.png"  width="80%" height="80%">
...
<img src="../images/posts/3/PowerAutomate - Create - KV - Read - Connected.png"  width="80%" height="80%">

#### Execute the Flow
Once the connection is fixed and should be able to execute the flow to connect and retrive the data from the KeyVault.

<img src="../images/posts/3/PowerAutomate - KV - Run - OK.png"  width="50%" height="50%">
